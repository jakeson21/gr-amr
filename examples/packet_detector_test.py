...
class packet_detector_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "packet_detector_test")
...
def main(top_block_cls=packet_detector_test, options=None):
